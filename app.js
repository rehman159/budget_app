...
var budgetController = (function () {
  ...
  return {
    ...
    calculateBudget: function () {
      // calculate total in come and expenses
      calculateTotal("exp");
      calculateTotal("inc");
      ...
      // calcuate the parentage of the income that we spent
      if (data.totals.inc > 0)
        data.percentage = Math.round((data.totals.exp / data.totals.inc) * 100);
...
var controller = (function (budgetCtrl, UICtrl) {
  ...
  var ctrlAddItem = function () {
    ...
    var input = UICtrl.getInput(); // input is an object returned by uicontroller contain type des val
...
controller.init(); // iginite the code
